...
<main>
    <div class="right">
        ...
        <form action="login.php" method="get">
            ...
            if (isset($_GET['email'])){
                ...
                $statement = $conn->prepare("SELECT * FROM `adhérents` WHERE `email` = '$email' AND `password` = '$pwd'");
                $statement->execute();
                ...
                if (count($result)==1){
                    ...
                    header("Location:http://localhost/labiral/");
                    exit();
                }else {
    ...
    <div class="left">
        <img src="../pic/International%20trade-rafiki.png" alt="">
    </div>
</main>
