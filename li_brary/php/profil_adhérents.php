...
<main>
    ...
    <div class="left">
            ...
            <form  action="update_img_profil.php" enctype="multipart/form-data" method="post">
                <div class="upload">
                    <div id="affishier-img">
                        <img src="../files/profil_img/<?= $profile_pic ?>" id="image">
                    </div>
        ...
        <div>
            ...
            <a type="button" href="http://localhost/labiral/" class="btn btn-danger"><i
                        class="fa-solid fa-arrow-right-from-bracket"></i> Back home</a>
        </div>
    </div>
    <form method="post" action="update_user.php" id="information" >
    <h3>Information personnels</h3>
    <div>
        <label for="email" class="">Email</label>
        <div class="input-group">
            <input  type="text" id="email" name="email" class="form-control mx-auto"
                   placeholder="Recipient's username"  value="<?= $email ?>">
    ...
    <div class="d-flex justify-content-end ">
        <button class="btn btn-primary " type="submit" id="save-changes">
